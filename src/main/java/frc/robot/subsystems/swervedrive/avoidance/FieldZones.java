...
public final class FieldZones {
  ...
  public static final Pose2d HUB_POSE_BLUE =
      new Pose2d(new Translation2d(FieldZones.ALLIANCE_ZONE_DEPTH + FieldZones.HUB_WIDTH / 2,
          FieldZones.FIELD_WIDTH / 2), Rotation2d.kZero);
  public static final Pose2d HUB_POSE_RED =
      new Pose2d(new Translation2d(FIELD_LENGTH - HUB_POSE_BLUE.getX(), HUB_POSE_BLUE.getY()),
