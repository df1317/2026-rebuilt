 ...
 * </pre>
 */
public class OurSwerveInputStream implements Supplier<ChassisSpeeds> {
	...
	/**
	 * Create a {@link OurSwerveInputStream} for an easy way to generate {@link ChassisSpeeds} from a driver controller.
	 *
	 * @param drive
	 *          {@link SwerveDrive} object for transformation.
	 * @param x
	 *          Translation X input in range of [-1, 1]
	 * @param y
	 *          Translation Y input in range of [-1, 1]
	 */
	private OurSwerveInputStream(SwerveDrive drive, DoubleSupplier x, DoubleSupplier y) {
	 ...
	 *          Translation Y input in range of [-1, 1]
	 * @param headingX
	 *          Heading X input in range of [-1, 1]
	 * @param headingY
	 *          Heading Y input in range of [-1, 1]
	 */
	public OurSwerveInputStream(SwerveDrive drive, DoubleSupplier x, DoubleSupplier y, DoubleSupplier headingX,
	...
	/**
	 * Create basic {@link OurSwerveInputStream} without any rotation components.
	 *
	 * @param drive
	 *          {@link SwerveDrive} object for transformation.
	 * @param x
	 *          {@link DoubleSupplier} of the translation X axis of the controller joystick to use.
	 * @param y
	 *          {@link DoubleSupplier} of the translation X axis of the controller joystick to use.
	 * @return {@link OurSwerveInputStream} to use as you see fit.
	 */
	public static OurSwerveInputStream of(SwerveDrive drive, DoubleSupplier x, DoubleSupplier y) {
		return new OurSwerveInputStream(drive, x, y);
	}

	/**
	 * Copy the {@link OurSwerveInputStream} object.
	 *
	 * @return Clone of current {@link OurSwerveInputStream}
	 */
	public OurSwerveInputStream copy() {
		OurSwerveInputStream newStream = new OurSwerveInputStream(swerveDrive, controllerTranslationX,
	 ...
	 *
	 * @param enabled
	 *          Robot-Relative {@link ChassisSpeeds} output.
	 * @return self
	 */
	public OurSwerveInputStream robotRelative(BooleanSupplier enabled) {
	 ...
	 * @return self
	 */
	public OurSwerveInputStream robotRelative(boolean enabled) {
	 ...
	 *
	 * @param pose
	 *          {@link Supplier<Pose2d>} for ease of use.
	 * @param xPIDController
	 *          PID controller for the translational axis, units are m/s.
	 * @param omegaPIDController
	 *          PID Controller for rotational axis, units are rad/s.
	 * @return self
	 */
	public OurSwerveInputStream driveToPose(Supplier<Pose2d> pose, ProfiledPIDController xPIDController,
	 ...
	 *
	 * @param enabled
	 *          Enable state of drive to pose.
	 * @return self.
	 */
	public OurSwerveInputStream driveToPoseEnabled(BooleanSupplier enabled) {
	 ...
	 * @return self.
	 */
	public OurSwerveInputStream driveToPoseEnabled(boolean enabled) {
	 ...
	 * @return self
	 */
	public OurSwerveInputStream translationHeadingOffset(BooleanSupplier enabled) {
	 ...
	 * @return self
	 */
	public OurSwerveInputStream translationHeadingOffset(boolean enabled) {
	 ...
	 *
	 * @param angle
	 *          {@link Rotation2d} offset to apply
	 * @return self
	 */
	public OurSwerveInputStream translationHeadingOffset(Rotation2d angle) {
	 ...
	 *
	 * @param enabled
	 *          Alliance aware {@link ChassisSpeeds} output.
	 * @return self
	 */
	public OurSwerveInputStream allianceRelativeControl(BooleanSupplier enabled) {
	 ...
	 * @return self
	 */
	public OurSwerveInputStream allianceRelativeControl(boolean enabled) {
	 ...
	 *
	 * @param enabled
	 *          Enabled state for the stream.
	 * @return self.
	 */
	public OurSwerveInputStream cubeRotationControllerAxis(BooleanSupplier enabled) {
	 ...
	 * @return self.
	 */
	public OurSwerveInputStream cubeRotationControllerAxis(boolean enabled) {
		omegaCube = Optional.of(() -> enabled);
		return this;
	}
	 ...
	 * @return self
	 */
	public OurSwerveInputStream cubeTranslationControllerAxis(BooleanSupplier enabled) {
	 ...
	 * @return self
	 */
	public OurSwerveInputStream cubeTranslationControllerAxis(boolean enabled) {
	 ...
	 *
	 * @param rot
	 *          Rotation axis with values from [-1, 1]
	 * @return self
	 */
	public OurSwerveInputStream withControllerRotationAxis(DoubleSupplier rot) {
		controllerOmega = Optional.of(rot);
		return this;
	}
	 ...
	 *
	 * @param headingX
	 *          Heading X axis with values from [-1, 1]
	 * @param headingY
	 *          Heading Y axis with values from [-1, 1]
	 * @return self
	 */
	public OurSwerveInputStream withControllerHeadingAxis(DoubleSupplier headingX, DoubleSupplier headingY) {
		controllerHeadingX = Optional.of(headingX);
		controllerHeadingY = Optional.of(headingY);
		return this;
	}
	 ...
	 *
	 * @param deadband
	 *          Deadband to set, should be between [0, 1)
	 * @return self
	 */
	public OurSwerveInputStream deadband(double deadband) {
		axisDeadband = deadband == 0 ? Optional.empty() : Optional.of(deadband);
		return this;
	}

	/**
	 * Scale the translation axis for {@link OurSwerveInputStream} by a constant scalar value.
	 *
	 * @param scaleTranslation
	 *          Translation axis scalar value. (0, 1]
	 * @return this
	 */
	public OurSwerveInputStream scaleTranslation(double scaleTranslation) {
		translationAxisScale = scaleTranslation == 0 ? Optional.empty() : Optional.of(scaleTranslation);
		return this;
	}

	/**
	 * Scale the rotation axis input for {@link OurSwerveInputStream} to reduce the range in which they operate.
	 *
	 * @param scaleRotation
	 *          Angular velocity axis scalar value. (0, 1]
	 * @return this
	 */
	public OurSwerveInputStream scaleRotation(double scaleRotation) {
	 ...
	 * @return this.
	 */
	public OurSwerveInputStream headingWhile(BooleanSupplier trigger) {
	 ...
	 *
	 * @param headingState
	 *          Heading enabled state.
	 * @return this
	 */
	public OurSwerveInputStream headingWhile(boolean headingState) {
		if (headingState) {
	 ...
	 *
	 * @param trigger
	 *          When True will enable aiming at the current target.
	 * @return this.
	 */
	public OurSwerveInputStream aimWhile(BooleanSupplier trigger) {
	 ...
	 * @return this.
	 */
	public OurSwerveInputStream aimWhile(boolean trigger) {
		if (trigger) {
	 ...
	 *
	 * @param trigger
	 *          Translation only while returns true.
	 * @return this
	 */
	public OurSwerveInputStream translationOnlyWhile(BooleanSupplier trigger) {
	 ...
	 *          Translation only if true.
	 * @return this
	 */
	public OurSwerveInputStream translationOnlyWhile(boolean translationState) {
		if (translationState) {
	...
	/**
	 * Find {@link SwerveInputMode} based off existing parameters of the {@link OurSwerveInputStream}
	 *
	 ...
	 *
	 * @param axisValue
	 *          Axis value to apply the deadband too.
	 ...
	 *
	 * @param axisValue
	 *          Axis value to apply teh scalar too.
	...
	/**
	 * Scale the translational axis by the {@link OurSwerveInputStream#translationAxisScale} if it exists.
	 *
	 * @param xAxis
	 *          X axis to scale.
	 * @param yAxis
	 ...
	 *
	 * @param translation
	 *          {@link Translation2d} representing controller input
	 * @return Cubed {@link Translation2d} if the {@link OurSwerveInputStream#translationCube} is present.
	 */
	 ...
	 *
	 * @param rotationAxis
	 *          Rotation controller axis to cube.
	 * @return Cubed axis value if the {@link OurSwerveInputStream#omegaCube} is present.
	 */
	 ...
	 *          Field or robot relative speeds to translate into robot-relative speeds.
	 ...
	 *
	 * @param fieldRelativeTranslation
	 *          Field-relative {@link Translation2d} to flip.
	...
	/**
	 * When the {@link OurSwerveInputStream} is in {@link SwerveInputMode#DRIVE_TO_POSE} this function will return if the
