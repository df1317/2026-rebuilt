...
public class AbsoluteDrive extends Command {
	 ...
	 * torwards/away from the alliance wall and y is left/right. headingHorzontal and headingVertical are the Cartesian
	 ...
	 * 		DoubleSupplier that supplies the horizontal component of the robot's heading angle. In the robot coordinate
	 * 		system, this is along the same axis as vY. Should range from -1 to 1 with no deadband.  Positive is towards the
	 * 		left wall when looking through the driver station glass.
	 * @param headingVertical
	 * 		DoubleSupplier that supplies the vertical component of the robot's heading angle.  In the robot coordinate
	 * 		system, this is along the same axis as vX. Should range from -1 to 1 with no deadband. Positive is away from the
	 * 		alliance wall.
	 */
