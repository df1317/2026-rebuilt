...
public class Force implements Interpolatable<Force>, ProtobufSerializable, StructSerializable {
	 ...
	 *
	 * @param vector
	 *          The translation vector to represent.
	 */
	 ...
	 *
	 * <p>
	 * The distance between translations is defined as âˆš((xâ‚‚âˆ’xâ‚)Â²+(yâ‚‚âˆ’yâ‚)Â²).
	 *
	 * @param other
	 ...
	 *
	 * <p>
	 * For example, rotating a Force of &lt;2, 0&gt; by 90 degrees will return a Force of &lt;0,
	 * 2&gt;.
	 *
	 * @param other
	 ...
	 *
	 * <p>
	 * For example, Force(5.0, 4.0) - Force(1.0, 2.0) = Force(4.0, 2.0).
	 *
	 * @param other
	 ...
	 *
	 * <p>
	 * For example, Force(2.0, 2.5) * 2 = Force(4.0, 5.0).
	 *
	 * @param scalar
