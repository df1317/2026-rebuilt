 ...
 *
 * <p>Use {@link #key(int, int)} to bind commands by physical position.
...
public class OperatorPanel extends CommandGenericHID {
     ...
     *
     * @param row 0-based row index, where 0 is the top row
     * @param col 0-based column index, where 0 is the leftmost column
